...
export const adventureQuery = [
  where("categories", "array-contains", "adventure"),
];
export const adventureQueryLimitTen = [...adventureQuery, ...orderByLimit];

export const userQueryNextPage = (
  orderByParam = "email",
  orderBySort = "asc",
  startAtParam = null
) => {
  if (startAtParam) {
    return [
      orderBy(orderByParam, orderBySort),
      limit(10),
...
export const userQueryPrevPage = (
  orderByParam = "email",
  orderBySort = "asc",
  endBeforeParam = null
) => {
...
export const userQueryPaginated = (
  orderByParam = "email",
  orderBySort = "asc",
  startAtParam = null
) => {
...
export const comicQueryNextPage = (
  comic,
  orderByParam = "title",
  orderBySort = "asc",
  startAtParam = null
  ...
  const comQuery =
    !comic || comic == "all" ? [] : [where("comics", "array-contains", comic)];
  if (startAtParam) {
    return [
      ...comQuery,
      orderBy(orderByParam, orderBySort),
...
export const comicQueryPrevPage = (
  comic,
  orderByParam = "title",
  orderBySort = "asc",
  endBeforeParam = null
...
export const comicQueryPaginated = (
  comic,
  orderByParam = "title",
  orderBySort = "asc",
  startAtParam = null
...
export const authorQueryPaginated = (
  author,
  orderByParam = "name",
  startAtParam = null
) => {
...
export const categoryQueryPaginated = (
  category,
  orderByParam = "title",
  startAtParam = null
) => {
...
export const tagQueryPaginated = (
  tag,
  orderByParam = "title",
  startAtParam = null
) => {
  const tagQuery =
    !tag || tag == "all" ? [] : [where("tags", "array-contains", tag)];
  if (startAtParam) {
    return [
      ...tagQuery,
      orderBy(orderByParam),
...
export const genreQueryPaginated = (
  genre,
  orderByParam = "name",
  startAtParam = null
) => {
  const genreQuery =
    !genre || genre == "all" ? [] : [where("genres", "array-contains", genre)];
  if (startAtParam) {
    return [
      ...genreQuery,
      orderBy(orderByParam),
...
export const searchQueryArrayAll = (
  searchQ,
  orderByParam = "title",
  startAtParam = null
) => {
  ...
  if (startAtParam) {
    return [
      where("keywords", "array-contains-any", searchQ),
      orderBy(orderByParam),
      startAfter(startAtParam),
    ];
  } else {
...
export const searchQueryMap = (searchQ) => {
  //, orderByParam = 'title', startAtParam = null) => {
  if (typeof searchQ == "string") {
    searchQ = [...new Set([...searchQ.split(" ")])];
  } else if (isObject(searchQ)) {
    searchQ = Object.keys(searchQ);
