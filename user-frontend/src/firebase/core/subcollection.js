...
export default class {
  ...
  static async createDocument(parentId, data) {
    try {
  ...
  static async getDocumentsCollectionWithStorageResource(
    queries = [],
    storageFields = [],
    loadInstance = false
  ) {
  ...
  static async getDocumentsCollectionWithStorageResourceUrl(
    queries = [],
    storageFields = [],
    loadInstance = false
  ) {
