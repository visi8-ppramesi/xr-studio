<template>
  ...
  >
        ...
        <div class="flex justify-start px-6">
          <div>
            <div class="form-check py-1">
              ...
              />
              <label
                id="equipments-side-category-item1"
            ...
            <div class="form-check py-1">
              ...
              />
              <label
                id="equipments-side-category-item2"
                class="form-check-label inline-block text-gray-800"
                for="flexCheckDefault"
              >
                Category 2
            ...
            <div class="form-check py-1">
              ...
              />
              <label
                id="equipments-side-category-item3"
                class="form-check-label inline-block text-gray-800"
                for="flexCheckDefault"
              >
                Category 3
            ...
            <div class="form-check py-1">
              ...
              />
              <label
                id="equipments-side-category-item4"
                class="form-check-label inline-block text-gray-800"
                for="flexCheckDefault"
              >
                Category 4
            ...
            <div class="form-check py-1">
              ...
              />
              <label
                id="equipments-side-category-item5"
                class="form-check-label inline-block text-gray-800"
                for="flexCheckDefault"
              >
                Category 5
    ...
    <div class="flex justify-center py-96">
