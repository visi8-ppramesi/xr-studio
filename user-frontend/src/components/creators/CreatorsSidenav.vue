    ...
    <ul class="relative px-1">
      <li class="relative">
        ...
        >
          ...
          <span id="non-collapsible">Non-collapsible link</span>
        </a>
      </li>
      <li class="relative" id="sidenavSecEx2">
        ...
        >
          ...
          <span id="item1-link">Collapsible item 1</span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
      ...
      <li class="relative" id="sidenavSecEx3">
        ...
        >
          ...
          <span id="collapsible2">Collapsible item 2</span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
    ...
    <ul class="relative px-1">
      <li class="relative">
        ...
        >
          ...
          <span id="non-collapsible2">Non-collapsible link</span>
        </a>
      </li>
      <li class="relative" id="sidenavXxEx2">
        ...
        >
          ...
          <span id="collapsible3">Collapsible item 3</span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
      ...
      <li class="relative" id="sidenavXxEx3">
        ...
        >
          ...
          <span id="collapsible4">Collapsible item 4</span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
