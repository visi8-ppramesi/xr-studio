<template>
  <section class="mb-32 md:mx-20 text-gray-800 text-center">
    ...
    <router-link
      ...
      data-mdb-ripple="true"
      data-mdb-ripple-color="light"
      class="inline-block px-6 py-2.5 my-8 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
      >See All Scenes</router-link
    >
  </section>
</template>
...
<script>
export default {
  name: "content-section-horizontal",
};
</script>
