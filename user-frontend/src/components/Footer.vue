<template>
  <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    <div
      class="flex justify-center items-center lg:justify-between py-6 px-8 border-b border-gray-300"
    >
    ...
    <div class="text-center p-6 bg-gray-200">
      ...
      <div class="text-gray-600 font-semibold">Visi8 Production</div>
    </div>
  </footer>
</template>
