...
export default {
  ...
  async_components: {
    "video-banner": {
      ...
      name: "video-banner",
      template:
        '<div id="async-banner" class="flex w-full h-full"><video playsinline autoplay muted loop v-show="videoSrc" :src="videoSrc" class="absolute w-full h-full object-cover"></video><div class="w-full h-full bg-black/50 items-center justify-center z-20 flex text-white"><img v-show="imgSrc" :src="imgSrc"></div></div>',
    },
    "banner-form-2": {
      data: '()=>({videoSrc:"https://firebasestorage.googleapis.com/v0/b/comics-77200.appspot.com/o/videos%2Fdashboard%2Ftest-compressed.mp4?alt=media&token=4d7a6536-0203-4698-ba2a-3cbed199b965",imgSrc:"https://firebasestorage.googleapis.com/v0/b/comics-77200.appspot.com/o/logos%2Fkara_logo.png?alt=media&token=7060c54a-8c85-4131-8f88-8a6c7ac84200"})',
    ...
    "async-component-test": {
      ...
      created:
        'created(){console.log("test-created");[1,2,3].forEach(console.log)}',
      mounted:
        'mounted(){console.log("test-mounted");[1,2,3].forEach(console.log)}',
      template: "<div></div>",
    },
  },
  comics: {
    "comic-1": {
      ...
      favorite_count: 3,
      description:
        "Eligendi sed amet eum odit qui voluptas. Possimus voluptatibus nemo minus sapiente rerum delectus. Odit occaecati voluptates quos. Aperiam quasi voluptatem itaque voluptatem beatae. Sint occaecati eius enim aut rerum quaerat.",
      ...
      chapters: {
        "chapter-1": {
          ...
          chapter_number: 1,
          chapter_preview_url:
            "gs://comics-77200.appspot.com/previews/cpt1_preview.jpeg",
          price: 1,
          release_date: mockDate(),
          view_count: 0,
          pages: {
      ...
      comments: {
        "comment-1": {
          ...
          user_data: {
            ...
            name: "ppramesii",
            profile_image_url:
              "gs://comics-77200.appspot.com/uploads/profile_images/hslN0mmWdxUFuAn3R4xd8gvlgLk2/alan_moore.jpg",
          },
        },
        "comment-2": {
          created_date: mockDate(),
    ...
    "comic-2": {
      ...
      release_date: mockDate(),
      description:
        "Soluta enim explicabo nostrum distinctio. Atque et amet molestiae voluptates. Quo vitae dicta ex voluptas. Quia fuga quia voluptatibus cum non itaque autem. Consequatur fugiat ullam minima velit ex. Voluptate exercitationem facere consequatur minus optio. Ut eos magni deserunt voluptatem nobis qui qui saepe numquam. Minus alias earum rem in eos aut veritatis magnam.",
      last_update: mockDate(),
      favorite_count: 1,
      authors: [
        {
  ...
  authors: {
    "author-1": {
      description:
        "He is the writer of Kara, Guardian of Realms. He has been writing for 10 years.",
      social_media_links: {
      ...
      user_id: null,
      profile_picture_url:
        "gs://comics-77200.appspot.com/uploads/profile_images/hslN0mmWdxUFuAn3R4xd8gvlgLk2/fembriarto.jpg",
    },
    "author-2": {
      description:
        "He is the writer of Kara, Guardian of Realms. He has been writing for 10 years.",
